                                ...
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                        ...
                                        VStack(alignment: .leading){
                                            ...
                                            Spacer()
                                            Text(String(format: "%.f%%", progress1)).font(.system(size: 24)).foregroundStyle(Color.black).fontWeight(.bold)
                                            Spacer()
                                            ZStack(alignment: .leading){
                                                ...
                                                Rectangle()
                                                    ...
                                                    .frame(width: geometry.size.width * progress1/100 * 0.4  ,height: 10)
